...
narrativo.   
• Meta: Obtener un plan "cerrado y narrativo" en menos de 2 minutos. Javier no quiere solo
una lista de sitios, quiere que una IA le explique por qué ese plan es el mejor para él hoy.  
• Por qué nos elige: Javier valora que TravelSense use IA Generativa para procesar toda la
información por él, dándole un resultado procesado y no datos en bruto.
