...
<mxGraphModel>
  <root>
    ...
    <!-- generador.py -->
    <mxCell id="7" value="generador.py&#xa;Lógica de generación&#xa;de itinerarios" style="rounded=1;fillColor=#fff2cc;strokeColor=#d6b656;fontSize=11;" vertex="1" parent="1">
      <mxGeometry x="620" y="310" width="180" height="70" as="geometry"/>
    </mxCell>
    ...
    <!-- Flecha generador -> Backend -->
    <mxCell id="12" value="import" style="edgeStyle=orthogonalEdgeStyle;dashed=1;" edge="1" source="7" target="3" parent="1">
      <mxGeometry relative="1" as="geometry"/>
    </mxCell>
  </root>
</mxGraphModel>
